...
echo "[init] writing /root/.torcs/config/screen.xml (fullscreen=yes, 1280x720, bpp=32, gamma=1.0)"
...
<!-- Generated by OVERRIDE torcs_container_init.sh — Phase 2.7 v6.
     ...
     Resolution dropped from 1920x1080 to 1280x720 to stay inside Mesa

...
| ~~`langflow.patrickndille.com`~~ | ~~`http://localhost:7860`~~ | **Route deleted** | Out of v1 scope. Langflow is a local compose service brought up with `podman-compose up override langflow`; it is intentionally not tunneled. |

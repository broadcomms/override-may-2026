...
- Pre-captured `data/samples/torcs_*.json` replays serve as the canonical demo fixtures; the submission video available through `https://override-video.patrickndille.com` plays these via fixture-mode (`?fixture=1`) for determinism.

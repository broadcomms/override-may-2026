...
> An explainable AI race-strategy copilot that helps teams and fans understand 2026 hybrid energy decisions. Powered by IBM Granite, Docling, and Langflow.
...
- **Upload-first.** Drop in a TORCS lab session or supported FastF1-style replay export. Get a debrief in under 30 seconds.

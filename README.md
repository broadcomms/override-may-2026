...
| **Live per-lap SSE telemetry stream** | Phase 3 of the v1.1 plan — pushes lap completions as gym_torcs writes them; v1.0 ships lap-paced batch ingest only via `POST /api/sessions/torcs-live` | [`docs/roadmap-v1.1/interactive-torcs-integration.md`](docs/roadmap-v1.1/interactive-torcs-integration.md) §3 |
